        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cedula = table.Column<int>(type: "int", unicode: false, maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Cliente__", x => x.idCliente);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    valor_Unitario = table.Column<decimal>(type: "decimal(18,2)", unicode: false, maxLength: 100, nullable: false),
                    stock = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Producto__07F4A132B3DE1442", x => x.idProducto);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__DetalleV__", x => x.idDetalleVenta);
                    table.ForeignKey(
